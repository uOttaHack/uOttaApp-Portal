  ...
  return (
    ...
    >
      <div className='container mx-auto flex px-5 py-24 items-center justify-center flex-col '>
        <h1 className='title-font sm:text-4xl text-3xl mb-8 font-medium text-gray-900 text-center lg:text-left'>
          👋 Welcome to uOttaApp!
        </h1>
        <p className='mb-16 leading-relaxed text-center lg:text-left sm:text-md'>
